function teknomia_Load(t)
	...
	s(),sortBy="titleasc",sortPosts(sortBy),sortlabel(),teknomia_MenuisiLoaded=!0,displayteknomia_Menuisi2(),document.write()
}
...
function sortlabel()
	...
	s<postTitle.length;
		...
		{
		teknomia_Labels=postLabels[s],firsti=t;
		do t+=1;
		while(postLabels[t]==teknomia_Labels);
...
function displayteknomia_Menuisi2()
	{
	for(var t=0,s=0;
	s<postTitle.length;
	)
		{
		teknomia_Labels=postLabels[s],document.write("<p/>"),document.write('<span class="teknomia_Label"><a href="/search/label/'+teknomia_Labels+'">'+teknomia_Labels+"</a></span><ol class='teknomia_Postname'>"),firsti=t;
...
var periksa="100",postTitle=new Array,postUrl=new Array,postMp3=new Array,postDate=new Array,postLabels=new Array,postBaru=new Array,sortBy="titleasc",teknomia_MenuisiLoaded=!1,numChars=250,postFilter="",numberfeed=0;
